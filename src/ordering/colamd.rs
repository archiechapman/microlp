...
//!
//! Picks the column elimination order the LU factorization uses, trading a
//! little ordering work for much less fill-in. [`ColsQueue`] is the bucket
//! queue that keeps "cheapest remaining column" an O(1) lookup.

use super::cols_queue::{ColsQueue, Slice};
